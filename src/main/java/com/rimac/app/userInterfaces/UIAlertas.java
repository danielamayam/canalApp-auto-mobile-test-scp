...
public class UIAlertas {
    ...
    public static final Target BTN_ALERTAS (int value) {
        return Target.the("Boton alertas")
                .locatedForAndroid(AppiumBy.xpath("((//android.widget.TextView[@text='Por ahora no']) | (//*[@text='Entendido']) | (//android.widget.Button[@text='Conocer más']) | (//*[@text='Activa tu seguro vehicular hoy']//preceding-sibling::android.widget.ImageButton[@content-desc='Cerrar modal']) | (//android.widget.ImageButton[@content-desc=\"Cerrar modal\"]) | (//android.widget.Button[@text='Vamos a Estar Bien']) | (//*[@text='Estar Bien']//preceding-sibling::android.widget.ImageButton[ends-with(@resource-id,'dialog_close')]))["+value+"]"))
    ...
    public static final Target BTN_ALERTAS = Target.the("Boton alertas")
                .locatedForAndroid(AppiumBy.xpath("(//android.widget.TextView[@text='Por ahora no']) | (//*[@text='Entendido']) | (//android.widget.Button[@text='Conocer más']) | (//*[@text='Activa tu seguro vehicular hoy']//preceding-sibling::android.widget.ImageButton[@content-desc='Cerrar modal']) | (//*[@text='Estar Bien']//preceding-sibling::android.widget.ImageButton[ends-with(@resource-id,'dialog_close')]) | (//android.widget.Button[@text='Vamos a Estar Bien']) | (//android.widget.ImageButton[@content-desc=\"Cerrar modal\"])"))
